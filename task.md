...
- [ ] Thống nhất `detector_backend` giữa luồng đăng ký (duplicate-check) và luồng chấm công — hiện dùng 2 backend khác nhau (`opencv` vs `retinaface`) nên duy trì 2 cache `.pkl` riêng, tốn gấp đôi công tính embedding
